...
{
    public abstract class PenaltyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PenaltyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PenaltyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PenaltyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PenaltyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PenaltyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PenaltyDbContext, Task<T>> func)
        {
            T result;
